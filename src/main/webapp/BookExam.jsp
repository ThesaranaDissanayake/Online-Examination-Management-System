...
<nav class="w3-sidebar w3-bar-block w3-card w3-animate-left w3-center" style="display:none" id="mySidebar">
  ...
  <a href="Student_Home.jsp" class="w3-bar-item w3-button">Home</a>
  <a href="Search.jsp" class="w3-bar-item w3-button">Results</a>
...
<header class="w3-container w3-theme w3-padding" id="myHeader">
  ...
  <h1 class="w3-xxxlarge w3-animate-bottom">Register for Exam</h1>
    <div class="w3-padding-32">
      <button class="w3-btn w3-xlarge w3-dark-grey w3-hover-light-grey" onclick="document.getElementById('id01').style.display='block'" style="font-weight:900;">time table</button>
    </div>
  </div>
</header>
...
<form action="INSERT_FORM" method="post">
    ...
    <div class="elem-group">
        ...
        <input type="text" id="name" name="id" placeholder="IT2....." pattern=[A-Z\sa-z]{1,3}[0-9]{1,6} required>
      </div>
    <div class="elem-group">
    ...
    <div class="elem-group">
        ...
        <input type="tel" id="phone" name="Year" placeholder="" required>
      </div>

      <div class="elem-group">
        <label for="phone">Semester</label>
        <input type="tel" id="phone" name="semester" placeholder="" required>
      </div>

    <div class="elem-group">
      <label for="phone">Your Phone</label>
      <input type="tel" id="phone" name="phone" placeholder="07.-348-3872" pattern=(\d{3})?\s?(\d{3})\s?(\d{4}) required>
    </div>
    <hr>
    
    <div class="elem-group">
      <label for="room-selection">Select Room Preference</label>
      <select id="room-selection" name="module_name" required>
          <option value="">Choose a Module from the List</option>
          <option value="connecting">Engilish</option>
          <option value="adjoining">Database Management Syatem</option>
          <option value="adjacent">Object Oriented Programming</option>
      </select>
    </div>
    <hr>
    <button type="submit">Book The Exam</button>
  </form>
