...
<header class="w3-container w3-theme w3-padding" id="myHeader">
  ...
  <h1 class="w3-xxxlarge w3-animate-bottom">Online Exam portral</h1>
...
<div class="w3-third">
  ...
  <h3><a href="BookExam.jsp">Register for Exams</a></h3><br>
  <i class="fa fa-desktop w3-margin-bottom w3-text-theme" style="font-size:120px"></i>
  <p>Built-in responsiveness</p>
  <p>Mobile first fluid grid</p>
  <p>make online today</p>
  <p>Goto the global world exams</p>
  </div>
</div>

<div class="w3-third">
  <div class="w3-card w3-container" style="min-height:460px">
  <h3><a href="Search.jsp">results</a></h3><br>
  <i class="fa fa-css3 w3-margin-bottom w3-text-theme" style="font-size:120px"></i>
  <p>Standard Results only</p>
  <p>Easy to learn</p>
...
<div class="w3-third">
  <div class="w3-card w3-container" style="min-height:460px">
  <h3><a href="contactus.jsp">Contact Us</a></h3><br>
